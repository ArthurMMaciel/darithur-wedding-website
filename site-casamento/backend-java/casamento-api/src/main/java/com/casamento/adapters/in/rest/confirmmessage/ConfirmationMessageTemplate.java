...
public enum ConfirmationMessageTemplate {
    ...
    GUEST("""
        ...
        Data: 25/06/2025
        Locais:
        Igreja (São José Operário): Praça Emíliano Perneta, s/n - Vila Operária, Maringá - PR, 87050-070
        Festa (Buffet Paradise): Av. Paranavaí, 2219 - Parque Industrial Bandeirantes, Maringá - PR, 87070-130
